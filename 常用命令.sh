...
bash train.sh ../data/generation/datasets/Meta-Llama-3-8B/mix_wiki_alpaca_8000.json /dev/shm/zhichenz/ckpts/Meta-Llama-3-8B/int2-g32-test ./logs/Meta-Llama-3-8B/int2-g32-test/ 4
